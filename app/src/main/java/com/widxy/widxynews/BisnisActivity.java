...
public class BisnisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new NewsAdapter(BisnisActivity.this, list);

        news.setHasFixedSize(true);
        news.setLayoutManager(new LinearLayoutManager(BisnisActivity.this));
    ...
    public void refresh() {
        loading = new ProgressDialog(BisnisActivity.this);
        ...
        api.getListNews("id", category, BuildConfig.NEWS_API_TOKEN).enqueue(new Callback<ResponNews>() {
            ...
            public void onResponse(Call<ResponNews> call, Response<ResponNews> response) {
                if (response.isSuccessful()){
                    ...
                    news.setAdapter(new NewsAdapter(BisnisActivity.this, list));
                    adapter.notifyDataSetChanged();
                } else {
                    hideDialog();
                    Toast.makeText(BisnisActivity.this, "Gagal mengambil data !", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<ResponNews> call, Throwable t) {
                hideDialog();
                Toast.makeText(BisnisActivity.this, "Gagal menyambung ke internet !", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public boolean onSupportNavigateUp() {
        Intent intent = new Intent(BisnisActivity.this, MainActivity.class);

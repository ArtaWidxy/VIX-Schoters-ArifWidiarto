...
public class TechnologyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new NewsAdapter(TechnologyActivity.this, list);

        news.setHasFixedSize(true);
        news.setLayoutManager(new LinearLayoutManager(TechnologyActivity.this));
    ...
    private void refresh() {
        loading = new ProgressDialog(TechnologyActivity.this);
